# -*- coding: utf-8 -*-
"""
Created on Sun Aug 22 09:09:07 2021
    ...
    for pose_class_name in self._pose_class_names:
      ...
      with open(csv_out_path, 'w') as csv_out_file:
        ...
        for image_name in tqdm.tqdm(image_names):
          ...
          with mp_pose.Pose(static_image_mode=False) as pose_tracker:
...
bootstrap_images_in_folder = r'C:\Users\King alagbe\Videos\CV\DATASET\TRAIN'

# Output folders for bootstrapped images and CSVs.
bootstrap_images_out_folder = r'C:\Users\King alagbe\Videos\CV\DATASET\image_poses_out'
bootstrap_csvs_out_folder = r'C:\Users\King alagbe\Videos\CV\DATASET\poses_csv'
...
bootstrap_helper.bootstrap(per_pose_class_limit=53)